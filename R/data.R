#' "Fadul 1-1", "Fadul 1-2", and "Fadul 2-1" cartridge cases from Fadul et al.
#' (2011) in their raw format
#'
#' An x3p (XML 3D Surface Profile) object containing the "Fadul 1-1", "Fadul
#' 1-2", and "Fadul 2-1" cartridge cases from Fadul et al. (2011) in their raw
#' format
#'
