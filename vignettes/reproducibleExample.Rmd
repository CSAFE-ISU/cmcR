...
km2_residuals <- selectBFImpression_sample_x3p(x3p_path = "https://tsapps.nist.gov/NRBTD/Studies/CartridgeMeasurement/DownloadMeasurement/cb296c98-39f5-46eb-abff-320a2f5568e8",
                                               ...
                                               useResiduals = TRUE,
                                               gaussFilterWavelength = c(16,400),
                                               gaussFilterType = "bp")
...
```{r}
any(c(nrow(km1_unknown1_cmcs$initialCMCs$comparison_1to2) > 0,
      nrow(km1_unknown1_cmcs$initialCMCs$comparison_2to1) > 0,
...
```{r}
any(c(nrow(km2_unknown1_cmcs$initialCMCs$comparison_1to2) > 0,
      nrow(km2_unknown1_cmcs$initialCMCs$comparison_2to1) > 0,
...
km1_unknown1_cmcPlots$initialCMC
```
...
km1_unknown2_cmcPlots$initialCMC
```
...
km2_unknown1_cmcPlots$initialCMC
```
...
km2_unknown2_cmcPlots$initialCMC
```
