...
knmPlts$originalMethodCMCs
```

## Bonus: CCF "Map"

```{r}
kmCellRegionPairs <- cmcR::getCellRegionPairs(fadul1.1$x3p,
                                              fadul1.2$x3p,
...
<!-- ```{r} -->
<!-- cmcR::cmcPlot(x3p = fadul1.1$x3p, -->
<!--               cmcDF = knmCMCs$`1.1_2.1`$originalMethodCMCs[[1]]$comparison_1to2) -->
<!-- ``` -->
...
<!--                        } -->
<!--                        else{ -->
<!--                          cmcs$originalMethodCMCs[[1]][[which.min(c(nrow(cmcs$originalMethodCMCs[[1]]$comparison_1to2),nrow(cmcs$originalMethodCMCs[[1]]$comparison_2to1)))]] %>% -->
<!--                            mutate(pair = rep(name,times = nrow(.)), -->
<!--                               comparisonType = "known non-match") %>% -->
<!--                            return() -->
<!--                        } -->
