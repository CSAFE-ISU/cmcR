...
if(!exists("skipPreprocess")){
  ...
  testthat::test_that("preProcess_ functions work as expected", {
    ...
    #final downsampled scan should have about half the dimension of original
    #(since original has odd dimension)
    testthat::expect_equal(dim(x3p1$surface.matrix), x3p1_intCrop_dim/2 + .5)
