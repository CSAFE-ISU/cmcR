...
We will want to exclude cells and regions that contain few observations. The `comparison_calcPropMissing` function calculates the proportion of missing values in a surface matrix.
