...
TODO:
  Write a cmcPerThetaPlot function that plots the CMCs per rotation value given ccfResults list?
  Function tests
  Package documentation (some exported functions still not showing up on pkgdown site)
